  ...
  const fetchLeaveStatus = async (ID, SL) => {
    try {
      ...
      const response = await fetch(
        `${clientUrl}api/ManagercoffApprovalList`,
        requestOptions,
      );
      const result = await response.json();
      console.log('coff', result);
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              const response = await fetch(
                `${clientUrl}api/ManagerLeaveCancel`,
                requestOptions,
              );
              const result = await response.json();
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              const response = await fetch(
                `${clientUrl}api/ManagerLeaveApproval`,
                requestOptions,
              );
              const result = await response.json();
              console.log('status', result);
      ...
      <View
        ...
        <View style={styles.row}>
          ...
          <View style={styles.detailsContainer}>
            ...
            <Text style={styles.text}>
              {' '}
              <Text style={styles.text1}>Day Type:</Text> {item.DayType}
            </Text>
          </View>
          {/* {status === 'orange' && ( */}
          {/* <TouchableOpacity
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView
        ...
        <Header title="Coff Approval" onBackPress={() => navigation.goBack()} />
        <ScrollView
